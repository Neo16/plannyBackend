    ...
    public class BllToDbEntityMappingProfile : Profile
    {
        public BllToDbEntityMappingProfile()
        {
            ...
            CreateMap<Participation, MyParticipationDto>()
               .ForMember(e => e.Id, f => f.MapFrom(k => k.Id))
               .ForMember(e => e.State, f => f.MapFrom(k => k.State == ParticipationState.Approved ? "Approved" : "Required"))
               ...
               .ForMember(e => e.PlannyCategories, f => f.MapFrom(k => k.Planny.PlannyCategories))
               .ForMember(e => e.NumOfAcceptedAttendees, f => f.MapFrom(k => k.Planny.Participations.Where(e => e.State == ParticipationState.Approved).Count()))
               .ForMember(e => e.NumOfRequestedAttendees, f => f.MapFrom(k => k.Planny.Participations.Where(e => e.State == ParticipationState.Required).Count()));
            ...
            CreateMap<Planny, PlannyDtoWithJoinStatus>()
             .IncludeBase<Planny, PlannyDto>();
        }
    }
}